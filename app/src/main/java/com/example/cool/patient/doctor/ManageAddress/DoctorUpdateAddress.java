...
public class DoctorUpdateAddress extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctor_update_address);
        ...
        myLati = getIntent().getStringExtra("lati");
        myLngi = getIntent().getStringExtra("longi");
        ...
        System.out.println("addressid..."+myAddressId);
        System.out.println("doc id from manage adapter.."+getUserId);
...
//                    @Override
//                    public void onClick(View v) {
//                        Intent intent = new Intent(DoctorUpdateAddress.this,DoctorManageAddress.class);
        ...
        expandableListView.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
                ...
                if (groupPosition == DoctorSideNavigationExpandableListAdapter.Services) {
                    ...
                    // call some activity here
                    Intent contact = new Intent(DoctorUpdateAddress.this,AboutUs.class);
                    startActivity(contact);
                    ...
                    // call some activity here
                    Intent contact = new Intent(DoctorUpdateAddress.this,Login.class);
                    startActivity(contact);
...
//                ).show();
                if (groupPosition == DoctorSideNavigationExpandableListAdapter.Services) {
                    if (childPosition == DoctorSideNavigationExpandableListAdapter.SUBITEM1_1) {
                        ...
                        Intent i = new Intent(DoctorUpdateAddress.this,DoctorDashboard.class);
                        i.putExtra("id",getUserId);
                        ...
                        Intent i = new Intent(DoctorUpdateAddress.this,DoctorTodaysAppointmentsForPatient.class);
                        i.putExtra("id",getUserId);
                        i.putExtra("mobile",regMobile);
                        startActivity(i);
...
//                    }
                    ...
                    if (childPosition == DoctorSideNavigationExpandableListAdapter.SUBITEM2_1) {
                        ...
                        Intent about = new Intent(DoctorUpdateAddress.this,DoctorAddAddress.class);
                        ...
                        Intent about = new Intent(DoctorUpdateAddress.this,DoctorManageAddress.class);
                        about.putExtra("id",getUserId);
                        about.putExtra("mobile",regMobile);
                        startActivity(about);
...
//            Toast.makeText(this,"Succesfully field" , Toast.LENGTH_SHORT).show();
        ...
        {
            Intent intent = new Intent(DoctorUpdateAddress.this,MapsActivity.class);
            intent.putExtra("doc","docUpdate");
            intent.putExtra("id",getUserId);
            ...
            intent.putExtra("mobile",landlineMobileNumber.getText().toString());
            ...
            System.out.println("emergency service.Update."+myAvailableService);
            intent.putExtra("comments",myComments);
            startActivity(intent);
        }
    }
...
//                data.put("EmergencyContact",myEmergencyContact);
    ...
    public void showSunalert(String txt)
    {
        ...
        final AlertDialog.Builder mBuilder2 = new AlertDialog.Builder(DoctorUpdateAddress.this);
