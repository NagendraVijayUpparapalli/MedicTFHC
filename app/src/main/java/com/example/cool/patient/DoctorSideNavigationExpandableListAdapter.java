...
public class DoctorSideNavigationExpandableListAdapter extends BaseExpandableListAdapter {
...
//    public static int SUBITEM1_3 = 2;
    ...
    public DoctorSideNavigationExpandableListAdapter(Context context, List<String> expandableListTitle,
    ...
    public View getChildView(int listPosition, final int expandedListPosition,
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.doctor_side_navigation_heading, null);
        }
