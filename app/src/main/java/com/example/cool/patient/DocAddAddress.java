...
public class DocAddAddress extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doc_add_address);
...
//        map = new HashMap<String, List<String>>();
        ...
        AlertDialog.Builder builder1 = new AlertDialog.Builder(DocAddAddress.this);
        builder1.setTitle("how many appointments want ??");

        MyDialog  = new Dialog(DocAddAddress.this);
...
//        map = new HashMap<String, List<String>>();
        ...
        final AlertDialog.Builder mBuilder2 = new AlertDialog.Builder(DocAddAddress.this);
