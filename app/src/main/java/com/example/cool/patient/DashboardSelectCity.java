...
public class DashboardSelectCity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dashboard_select_city);
...
//        current_location.setText(getcity);
        ...
        cancel_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(DashboardSelectCity.this,MainActivity.class);
                startActivity(i);
            }
        });
...
//      });
        ...
        selected_location.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position,
                ...
                Intent i = new Intent(DashboardSelectCity.this,MainActivity1.class);
