...
public class ViewPageAdapter2 extends PagerAdapter {
    ...
    private Integer[] images = {R.drawable.splashbanner,R.drawable.tvlogo,R.drawable.apinnovation};
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        final View view = layoutInflater.inflate(R.layout.custom_layout2, null);
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(position == 0){
                    ...
                    view.getContext().startActivity(new Intent(view.getContext(),tvvideomedic.class));
