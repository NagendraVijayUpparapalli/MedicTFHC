...
public class PatientDoctorListSelectCity extends AppCompatActivity {
...
//        searchView = (SearchView) findViewById(R.id.citysearch);
        ...
        cancel_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(PatientDoctorListSelectCity.this,GetCurrentDoctorsList.class);
                startActivity(i);
            }
        });
...
//      });
        ...
        selected_location.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position,
                ...
                Intent i = new Intent(PatientDoctorListSelectCity.this,GetCurrentDoctorsList11.class);
