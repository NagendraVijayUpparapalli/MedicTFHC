...
public class DoctorDashBoardSelectCity extends AppCompatActivity {

    TextView current_location,cancel_button;
    private android.widget.ListView selected_location;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctor_dash_board_select_city);
...
//        current_location.setText(getcity);
        ...
        cancel_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(DoctorDashBoardSelectCity.this,DoctorDashboard.class);
                startActivity(i);
            }
        });

        selected_location = (android.widget.ListView) findViewById(R.id.list_view);
...
//      });
        ...
        selected_location.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position,
                ...
                Intent i = new Intent(DoctorDashBoardSelectCity.this,DoctorDashBoard11.class);
