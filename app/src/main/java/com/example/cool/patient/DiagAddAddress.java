...
// base64 image variables
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_diag_add_address);
...
//                new sendEditProfileDetails().execute(baseUrl.getUrl()+"DiagnosticAddAddress",js.toString());
        ...
        fromTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                timePickerDialog = new TimePickerDialog(DiagAddAddress.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
...
//            }
    ...
    public void showalert() {
        ...
        timePickerDialog1 = new TimePickerDialog(DiagAddAddress.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
            public void onTimeSet(TimePicker timePicker, int hourOfDay, int minutes) {
                if (hourOfDay >= 12) {
                    amPm = "PM";
