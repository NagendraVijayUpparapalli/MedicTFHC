...
public class SideNavigationExpandableListAdapter  extends BaseExpandableListAdapter {
    ...
    public SideNavigationExpandableListAdapter(Context context, List<String> expandableListTitle,
