...
class PatientTodaysAppointmentsInDiagnosticsAdapter extends RecyclerView.Adapter<PatientTodaysAppointmentsInDiagnosticsAdapter.ViewHolder> {
    ...
    public PatientTodaysAppointmentsInDiagnosticsAdapter(Context context, List<PatientDatainDiagnosticsTodaysAppointmentsClass> data_list) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new PatientTodaysAppointmentsInDiagnosticsAdapter.ViewHolder(itemView);
    }
