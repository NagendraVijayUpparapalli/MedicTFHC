...
public class MyFamily extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
        ...
        expandableListView.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
                ...
                if (groupPosition == PatientSideNavigationExpandableListAdapter.ITEM1) {
                    ...
                    // call some activity here
                    Intent contact = new Intent(MyFamily.this,MyFamily.class);
                    ...
                    Intent contact = new Intent(MyFamily.this,Offers.class);
                    contact.putExtra("id",getUserId);
                    contact.putExtra("mobile",mobile_number);
                    contact.putExtra("module","patient");
                    startActivity(contact);
                    ...
                    Intent contact = new Intent(MyFamily.this,ReachUs.class);
                    contact.putExtra("id",getUserId);
                    contact.putExtra("mobile",mobile_number);
                    contact.putExtra("module","patient");
                    startActivity(contact);
                    ...
                    Intent contact = new Intent(MyFamily.this,Login.class);
                    startActivity(contact);
...
//        });
            ...
            public boolean onChildClick(ExpandableListView parent, View v,
                ...
                if (groupPosition == PatientSideNavigationExpandableListAdapter.ITEM1) {
                    if (childPosition == PatientSideNavigationExpandableListAdapter.SUBITEM1_1) {
                        ...
                        Intent i = new Intent(MyFamily.this,GetCurrentDoctorsList.class);
                        ...
                        Intent i = new Intent(MyFamily.this,GetCurrentDiagnosticsList.class);
                        i.putExtra("userId",getUserId);
                        i.putExtra("mobile",mobile_number);
                        startActivity(i);
                        ...
                        Intent in = new Intent(MyFamily.this,GetCurrentMedicalShopsList.class);
                        ...
                        // call activity here
                        Intent contact = new Intent(MyFamily.this,FindHospitals.class);
                        contact.putExtra("id",getUserId);
                        contact.putExtra("mobile",mobile_number);
                        contact.putExtra("module","patient");
                        startActivity(contact);
                        ...
                        // call activity here
                        Intent bloodbank = new Intent(MyFamily.this,BloodBank.class);
                        ...
                        // call activity here
                        Intent contact = new Intent(MyFamily.this,AmbulanceServices.class);
                        contact.putExtra("id",getUserId);
                        contact.putExtra("mobile",mobile_number);
                        contact.putExtra("module","patient");
                        startActivity(contact);
                    ...
                    if (childPosition == PatientSideNavigationExpandableListAdapter.SUBITEM3_1) {
                        ...
                        // call activity here
                        Intent intent = new Intent(MyFamily.this,ChangePassword.class);
                    ...
                    if (childPosition == PatientSideNavigationExpandableListAdapter.SUBITEM2_1) {
                        ...
                        Intent intent = new Intent(MyFamily.this,PatientMyDoctorAppointments.class);
                        intent.putExtra("mobile",mobile_number);
                        intent.putExtra("id",getUserId);
                        startActivity(intent);
                        ...
                        Intent intent = new Intent(MyFamily.this,PatientMyDiagnosticAppointments.class);
                        intent.putExtra("mobile",mobile_number);
                        intent.putExtra("id",getUserId);
                        startActivity(intent);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.qricon)
        {
            ...
            Intent intent = new Intent(MyFamily.this,PatientDashBoard.class);
            intent.putExtra("id",getUserId);
            intent.putExtra("mobile",mobile_number);
            startActivity(intent);
        }
    ...
    private class GetPatientDetails extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = new ProgressDialog(MyFamily.this);
