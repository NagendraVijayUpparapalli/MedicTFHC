...
public class DiagUpdateAddress extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_diag_update_address);
...
//        });
        ...
        FromTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                timePickerDialog = new TimePickerDialog(DiagUpdateAddress.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        speciality.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
//                Toast.makeText(DiagUpdateAddress.this,
...
//                        Toast.makeText(getApplicationContext(),prevSpecialityItemsList.get(i),Toast.LENGTH_SHORT).show();
                ...
                AlertDialog.Builder mBuilder2 = new AlertDialog.Builder(DiagUpdateAddress.this);
...
//                        Toast.makeText(PatientEditProfile.this, "clicking the Back!", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(DiagUpdateAddress.this,DiagnosticDashboard.class);
...
//            Toast.makeText(this,"Succesfully field" , Toast.LENGTH_SHORT).show();
        ...
        {
            Intent intent = new Intent(DiagUpdateAddress.this,MapsActivity.class);
...
//            encodedImage = myEncodeImage(selectedImage);
    ...
    private class sendDiagnosticsUpdateAdressDetails extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = new ProgressDialog(DiagUpdateAddress.this);
...
//                        dialog.cancel();
    ...
    public void showalert() {
        ...
        timePickerDialog1 = new TimePickerDialog(DiagUpdateAddress.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
            public void onTimeSet(TimePicker timePicker, int hourOfDay, int minutes) {
                if (hourOfDay >= 12) {
                    amPm = "PM";
