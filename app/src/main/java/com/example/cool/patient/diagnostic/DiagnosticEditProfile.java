...
public class DiagnosticEditProfile extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
        ...
        expandableListView.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
            public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
                ...
                if (groupPosition == DiagnosticSideNavigationExpandableListAdapter.Services) {
                    ...
                    // call some activity here
                    Intent contact = new Intent(DiagnosticEditProfile.this,Login.class);
                    startActivity(contact);
            ...
            public boolean onChildClick(ExpandableListView parent, View v,
                ...
                if (groupPosition == DiagnosticSideNavigationExpandableListAdapter.Services) {
                    if (childPosition == DiagnosticSideNavigationExpandableListAdapter.SUBITEM1_1) {
                        ...
                        Intent i = new Intent(DiagnosticEditProfile.this,DiagnosticDashboard.class);
                        ...
                        Intent i = new Intent(DiagnosticEditProfile.this,DiagnosticsTodaysAppointments.class);
...
//                    }
                    ...
                    if (childPosition == DiagnosticSideNavigationExpandableListAdapter.SUBITEM2_1) {
                        ...
                        Intent about = new Intent(DiagnosticEditProfile.this,DiagnosticAddAddress.class);
                        ...
                        Intent about = new Intent(DiagnosticEditProfile.this,DiagnosticManageAddress.class);
                        about.putExtra("id",getUserId);
                        about.putExtra("mobile",mobile_number);
                        startActivity(about);
...
//
    ...
    public void showSuccessMessage(String message){
        ...
        MyDialog  = new Dialog(DiagnosticEditProfile.this);
