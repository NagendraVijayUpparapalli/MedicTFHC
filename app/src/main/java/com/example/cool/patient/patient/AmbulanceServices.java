...
public class AmbulanceServices extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
...
//                    editProfile.putExtra("module","patient");
                    ...
                    // call some activity here
                    Intent contact = new Intent(AmbulanceServices.this,MyFamily.class);
                    ...
                    Intent contact = new Intent(AmbulanceServices.this,Offers.class);
                    contact.putExtra("id",getUserId);
                    contact.putExtra("mobile",mobile_number);
                    contact.putExtra("module","patient");
                    startActivity(contact);
                    ...
                    Intent contact = new Intent(AmbulanceServices.this,ReachUs.class);
                    contact.putExtra("id",getUserId);
                    contact.putExtra("mobile",mobile_number);
                    contact.putExtra("module","patient");
                    startActivity(contact);
                    ...
                    Intent contact = new Intent(AmbulanceServices.this,Login.class);
                    startActivity(contact);
            ...
            public boolean onChildClick(ExpandableListView parent, View v,
                ...
                if (groupPosition == PatientSideNavigationExpandableListAdapter.ITEM1) {
                    if (childPosition == PatientSideNavigationExpandableListAdapter.SUBITEM1_1) {
                        ...
                        Intent i = new Intent(AmbulanceServices.this,GetCurrentDoctorsList.class);
                        ...
                        Intent i = new Intent(AmbulanceServices.this,GetCurrentDiagnosticsList.class);
                        i.putExtra("userId",getUserId);
                        i.putExtra("mobile",mobile_number);
                        startActivity(i);
                        ...
                        Intent in = new Intent(AmbulanceServices.this,GetCurrentMedicalShopsList.class);
                        ...
                        // call activity here
                        Intent contact = new Intent(AmbulanceServices.this,FindHospitals.class);
                        contact.putExtra("id",getUserId);
                        contact.putExtra("mobile",mobile_number);
                        startActivity(contact);
                        ...
                        // call activity here
                        Intent bloodbank = new Intent(AmbulanceServices.this,BloodBank.class);
                        ...
                        // call activity here
                        Intent contact = new Intent(AmbulanceServices.this,AmbulanceServices.class);
                        contact.putExtra("id",getUserId);
                        contact.putExtra("mobile",mobile_number);
                        startActivity(contact);
                    ...
                    if (childPosition == PatientSideNavigationExpandableListAdapter.SUBITEM3_1) {
                        ...
                        // call activity here
                        Intent intent = new Intent(AmbulanceServices.this,ChangePassword.class);
                    ...
                    if (childPosition == PatientSideNavigationExpandableListAdapter.SUBITEM2_1) {
                        ...
                        Intent intent = new Intent(AmbulanceServices.this,PatientMyDoctorAppointments.class);
                        intent.putExtra("mobile",mobile_number);
                        intent.putExtra("id",getUserId);
                        startActivity(intent);
                        ...
                        Intent intent = new Intent(AmbulanceServices.this,PatientMyDiagnosticAppointments.class);
                        intent.putExtra("mobile",mobile_number);
                        intent.putExtra("id",getUserId);
                        startActivity(intent);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.qricon)
        {
            ...
            Intent intent = new Intent(AmbulanceServices.this,PatientDashBoard.class);
            intent.putExtra("id",getUserId);
            intent.putExtra("mobile",mobile_number);
            startActivity(intent);
        }
    ...
    private class GetPatientDetails extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = new ProgressDialog(AmbulanceServices.this);
