...
public class Offers extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            setContentView(R.layout.offer_doctor);
        }
        if(module.equals("diag"))
        {
            setContentView(R.layout.offer_diagnostics);
        }
        if(module.equals("medical"))
        {
            setContentView(R.layout.offer_medical);
        }
        ...
        System.out.print("userid in offers....." + getUserId);
...

            {
                public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
                    ...
                    if (groupPosition == PatientSideNavigationExpandableListAdapter.ITEM1) {
                        ...
                        // call some activity here
                        Intent contact = new Intent(Offers.this,MyFamily.class);
                        ...
                        Intent contact = new Intent(Offers.this,Offers.class);
                        contact.putExtra("id",getUserId);
                        contact.putExtra("mobile",mobile_number);
                        ...
                        Intent contact = new Intent(Offers.this,ReachUs.class);
                        contact.putExtra("id",getUserId);
                        contact.putExtra("mobile",mobile_number);
                        contact.putExtra("module","patient");
                        startActivity(contact);
                        ...
                        Intent contact = new Intent(Offers.this,Login.class);
                        startActivity(contact);
                ...
                public boolean onChildClick(ExpandableListView parent, View v,
                    ...
                    if (groupPosition == PatientSideNavigationExpandableListAdapter.ITEM1) {
                        if (childPosition == PatientSideNavigationExpandableListAdapter.SUBITEM1_1) {
                            ...
                            Intent i = new Intent(Offers.this, GetCurrentDoctorsList.class);
                            i.putExtra("userId", getUserId);
                            i.putExtra("mobile", mobile_number);
                            startActivity(i);

                        } else if (childPosition == PatientSideNavigationExpandableListAdapter.SUBITEM1_2) {
                            Intent i = new Intent(Offers.this, GetCurrentDiagnosticsList.class);
                            i.putExtra("userId", getUserId);
                            i.putExtra("mobile", mobile_number);
                            startActivity(i);
...
//                        startActivity(bloodbank);
                        ...
                        if (childPosition == PatientSideNavigationExpandableListAdapter.SUBITEM3_1) {
                            ...
                            // call activity here
                            Intent intent = new Intent(Offers.this, ChangePassword.class);
                        ...
                        if (childPosition == PatientSideNavigationExpandableListAdapter.SUBITEM2_1) {
                            ...
                            Intent intent = new Intent(Offers.this, PatientMyDoctorAppointments.class);
                            intent.putExtra("mobile", mobile_number);
                            intent.putExtra("id", getUserId);
                            startActivity(intent);

                        } else if (childPosition == PatientSideNavigationExpandableListAdapter.SUBITEM2_2) {
                            Intent intent = new Intent(Offers.this, PatientMyDiagnosticAppointments.class);
                            intent.putExtra("mobile", mobile_number);
                            intent.putExtra("id", getUserId);
                            startActivity(intent);
            ...
            expandableListView.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
                public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
                    ...
                    if (groupPosition == DoctorSideNavigationExpandableListAdapter.Services) {
                        ...
                        Intent i = new Intent(Offers.this,ReachUs.class);
                        i.putExtra("id",getUserId);
                        i.putExtra("mobile",mobile_number);
                        i.putExtra("module","doc");
                        startActivity(i);
...
//                ).show();
                    if (groupPosition == DoctorSideNavigationExpandableListAdapter.Services) {
                        if (childPosition == DoctorSideNavigationExpandableListAdapter.SUBITEM1_1) {
                            ...
                            Intent i = new Intent(Offers.this,DoctorDashboard.class);
                            i.putExtra("id",getUserId);
                            i.putExtra("mobile",mobile_number);
                            startActivity(i);
                            ...
                            Intent i = new Intent(Offers.this,DoctorTodaysAppointmentsForPatient.class);
                            i.putExtra("id",getUserId);
                            i.putExtra("mobile",mobile_number);
                            startActivity(i);
...
//                    }
                        ...
                        if (childPosition == DoctorSideNavigationExpandableListAdapter.SUBITEM2_1) {
                            ...
                            Intent about = new Intent(Offers.this,DoctorAddAddress.class);
                            about.putExtra("id",getUserId);
                            about.putExtra("mobile",mobile_number);
                            startActivity(about);
                            ...
                            Intent about = new Intent(Offers.this,DoctorManageAddress.class);
                            about.putExtra("id",getUserId);
                            about.putExtra("mobile",mobile_number);
                            startActivity(about);
                ...
                public boolean onChildClick(ExpandableListView parent, View v,
                    ...
                    if (groupPosition == MedicalShopSideNavigationExpandableListAdapter.ITEM3) {
                        ...
                        if (childPosition == MedicalShopSideNavigationExpandableListAdapter.SUBITEM2_1) {
                            ...
                            Intent about = new Intent(Offers.this,MedicalShopAddAddress.class);
                            about.putExtra("id",getUserId);
                            about.putExtra("mobile",mobile_number);
                            startActivity(about);
                            ...
                            Intent about = new Intent(Offers.this,MedicalShopManageAddress.class);
                            about.putExtra("id",getUserId);
                            about.putExtra("mobile",mobile_number);
                            startActivity(about);
            ...
            expandableListView.setOnGroupClickListener(new ExpandableListView.OnGroupClickListener() {
                public boolean onGroupClick(ExpandableListView parent, View v, int groupPosition, long id) {
                    ...
                    if (groupPosition == DiagnosticSideNavigationExpandableListAdapter.Services) {
                        ...
                        // call some activity here
                        Intent subscript = new Intent(Offers.this,SubscriptionPlanAlertDialog.class);
                ...
                public boolean onChildClick(ExpandableListView parent, View v,
                    ...
                    if (groupPosition == DiagnosticSideNavigationExpandableListAdapter.Services) {
                        if (childPosition == DiagnosticSideNavigationExpandableListAdapter.SUBITEM1_1) {
                            ...
                            Intent i = new Intent(Offers.this,DiagnosticDashboard.class);
                            i.putExtra("id",getUserId);
                            i.putExtra("mobile",mobile_number);
                            startActivity(i);
                            ...
                            Intent i = new Intent(Offers.this,DiagnosticsTodaysAppointments.class);
                            i.putExtra("userId",getUserId);
                            i.putExtra("mobile",mobile_number);
                            startActivity(i);
...
//                    }
                        ...
                        if (childPosition == DiagnosticSideNavigationExpandableListAdapter.SUBITEM2_1) {
                            ...
                            Intent about = new Intent(Offers.this,DiagnosticAddAddress.class);
                            about.putExtra("id",getUserId);
                            about.putExtra("mobile",mobile_number);
                            startActivity(about);
                            ...
                            Intent about = new Intent(Offers.this,DiagnosticManageAddress.class);
                            about.putExtra("id",getUserId);
                            about.putExtra("mobile",mobile_number);
                            startActivity(about);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id==R.id.qricon)
        {
            if(module.equals("patient"))
            {
                Intent intent = new Intent(Offers.this,PatientDashBoard.class);
                intent.putExtra("id",getUserId);
                intent.putExtra("mobile",mobile_number);
                startActivity(intent);
            }
            if(module.equals("doc"))
            {
                Intent intent = new Intent(Offers.this,DoctorDashboard.class);
                intent.putExtra("id",getUserId);
                intent.putExtra("mobile",mobile_number);
                startActivity(intent);
            }
            if(module.equals("diag"))
            {
                Intent intent = new Intent(Offers.this,DiagnosticDashboard.class);
                intent.putExtra("id",getUserId);
                intent.putExtra("mobile",mobile_number);
                startActivity(intent);
            }
            if(module.equals("medical"))
            {
                Intent intent = new Intent(Offers.this,MedicalShopDashboard.class);
                intent.putExtra("id",getUserId);
                intent.putExtra("mobile",mobile_number);
                startActivity(intent);
            }
    ...
    private class GetPatientDetails extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = new ProgressDialog(Offers.this);
...
//                TextView sidenavName,sidenavEmail,sidenavAddress,sidenavMobile;
    ...
    private class GetDoctorDetails extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            // Create a progressdialog
            progressDialog1 = new ProgressDialog(Offers.this);
            // Set progressdialog title
//            progressDialog.setTitle("You are logging");
            // Set progressdialog message
...
//                httpURLConnection.setDoOutput(true);
    ...
    private class GetMedicalDetails extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            // Create a progressdialog
            progressDialog2 = new ProgressDialog(Offers.this);
            // Set progressdialog title
...
//                httpURLConnection.setDoOutput(true);
    ...
    private class GetDiagnosticDetails extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            // Create a progressdialog
            progressDialog3 = new ProgressDialog(Offers.this);
            // Set progressdialog title
//            progressDialog.setTitle("You are logging");
            // Set progressdialog message
