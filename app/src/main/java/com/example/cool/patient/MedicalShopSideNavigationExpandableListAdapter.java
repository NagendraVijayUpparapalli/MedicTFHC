...
public class MedicalShopSideNavigationExpandableListAdapter extends BaseExpandableListAdapter {
...
//    public static int SUBITEM1_3 = 2;
    ...
    public MedicalShopSideNavigationExpandableListAdapter(Context context, List<String> expandableListTitle,
    ...
    public View getChildView(int listPosition, final int expandedListPosition,
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.medicalshop_side_navigation_heading, null);
        }
...
//        }
    ...
    public View getGroupView(int listPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            LayoutInflater layoutInflater = (LayoutInflater) this.context.
                    getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = layoutInflater.inflate(R.layout.medicalshop_side_navigation_subheading, null);
        }
...
//        listTitleTextIconView.setTypeface(FontManager.getTypeface(context, FontManager.FONTAWESOME));
        ...
        if (listPosition == Address || listPosition == ITEM3) {
            if (!isExpanded)
