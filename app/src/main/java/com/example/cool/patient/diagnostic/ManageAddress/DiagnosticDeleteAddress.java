...
import com.example.cool.patient.doctor.ManageAddress.DoctorDeleteAddress;
...
public class DiagnosticDeleteAddress extends AppCompatActivity {

    ProgressDialog progressDialog;

    ApiBaseUrl baseUrl = new ApiBaseUrl();

    String diagId, addId, comment,mobile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_diagnostic_delete_address);
        ...
        System.out.println("intent diagid..."+getIntent().getStringExtra("DiagID"));
        ...
        new sendDetailsToDeleteDoctorAddress().execute(baseUrl.getUrl()+"DiagnosticDeleteAddress?DiagnosticsID="+diagId
...
//            progressDialog.dismiss();
    ...
    public void showSuccessMessage(String message1){
        ...
        MyDialog  = new Dialog(DiagnosticDeleteAddress.this);
        ...
        oklink.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DiagnosticDeleteAddress.this,DiagnosticDashboard.class);
